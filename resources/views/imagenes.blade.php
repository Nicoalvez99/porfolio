<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Imágenes para proyectos') }}
        </h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('imagenes.proyecto') }}" method="post" enctype="multipart/form-data">
                @csrf @method('patch')
                <button type="submit" name="btnNuevoStack" class="bg-blue-500 hover:bg-blue-700 text-white w-full lg:w-1/4 my-5 font-bold py-2 px-4 rounded" style="background-color: #4299E1; margin: 10px 0px;">Subir</button>
                            ...
                            <div class="block sm:flex" data-aos="fade-right">
                                ...
                                <div class="w-full lg:w-1/2">
                                    <div class="my-3">
                                        ...
                                        <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="proyecto" id="">
